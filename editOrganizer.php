...
<?php
 ...
 $sql = "UPDATE organizer SET poster = '$target_file', series_no = '$series_no', category = '$category', organization = '$organization', event_name = '$event_name', venue = '$venue', `date`=  '$date', `time` =  '$time' WHERE id='$id'";
